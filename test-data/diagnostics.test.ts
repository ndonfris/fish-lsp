...
import {setLogger, resolveLspDocumentForHelperTestFile} from './helpers';
let parser: Parser;

setLogger(
  async () => { parser = await initializeParser() },
  async () => { parser.reset() }
)
...
describe('diagnostics test suite', () => {
  ...
  it('diagnostic test 1', async () => {
    // TODO
    expect(true).toBe(true)
  })

  it('diagnostic test 2', async () => {
    // TODO
    expect(true).toBe(true)
  })
