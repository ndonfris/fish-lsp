...
exports.hasPossibleSubCommand = exports.isBuiltin = exports.BuiltInList = void 0;
exports.BuiltInList = [
    "[",
    "_",
    "and",
...
function hasPossibleSubCommand(cmd) {
    return SubCommandSet.has(cmd);
}
exports.hasPossibleSubCommand = hasPossibleSubCommand;
