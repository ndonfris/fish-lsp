...
export namespace ErrorCodes {
  ...
  export const missingOptionValue = 1007;
  ...
  export const codes: { [k in CodeTypes]: CodeValueType } = {
    ...
    [missingOptionValue]: {
      ...
      codeDescription: { href: 'https://fishshell.com/docs/current/language.html#argument-handling' },
      source: 'fish-lsp',
    ...
    [autoloadedHelperFunctionNameCollision]: {
      severity: DiagnosticSeverity.Information,
      code: autoloadedHelperFunctionNameCollision,
      codeDescription: { href: 'https://fishshell.com/docs/current/cmds/functions.html' },
      source: 'fish-lsp',
      message: 'Autoloaded helper function name collides with another helper function',
    },
    ...
    [fishStatusDeprecatedFlag]: {
      severity: DiagnosticSeverity.Warning,
      code: fishStatusDeprecatedFlag,
      codeDescription: { href: 'https://fishshell.com/docs/current/cmds/status.html#notes' },
      source: 'fish-lsp',
      message: 'Deprecated status flag',
    },
    [unknownCommand]: {
      severity: DiagnosticSeverity.Warning,
      code: unknownCommand,
