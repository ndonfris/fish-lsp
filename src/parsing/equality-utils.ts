...
// import { containsNode } from '../utils/tree-sitter';
//
...
// const rangesEqual = (range1: Range, range2: Range): boolean => {
...
// };
//
// // Main equality checker that combines all checks
// export const areSymbolsEqual = (symbolA: FishSymbol, symbolB: FishSymbol): boolean => {
...
// };
//
// // Check if scopes are equal (used by containsScope)
...
//   const scopeContains = containsNode(a.scope.scopeNode, b.scope.scopeNode);
//
...
// };
//
// // Check scope containment for non-variables
...
//     }
//
//     return haveSameScopeNode({ a, b }) || containsNode(a.scope.scopeNode, b.scope.scopeNode);
//   }
//
...
// export const doesSymbolContainScope = (symbolA: FishSymbol, symbolB: FishSymbol): boolean => {
//   const pair: SymbolPair = { a: symbolA, b: symbolB };
//
...
// };
//
// // Main scope equality checker (used by both containsScope and other methods)
// export const areSymbolScopesEqual = (symbolA: FishSymbol, symbolB: FishSymbol): boolean => {
//   return haveEqualScopes({ a: symbolA, b: symbolB });
// };
//
// // Check if a FishSymbol is equal to the `Location` passed in
// export const areSymbolEqualLocations = (symbol: FishSymbol, location: Location): boolean => {
//   return symbol.uri === location.uri
//     && symbol.selectionRange.start.line === location.range.start.line
//     && symbol.selectionRange.start.character === location.range.start.character
//     && symbol.selectionRange.end.line === location.range.end.line
//     && symbol.selectionRange.end.character === location.range.end.character;
// }
...
// export const doesSymbolEqualLocation = (symbol: FishSymbol, location: Location): boolean => {
//   return symbol.uri === location.uri &&
...
// export const areSymbolsSameDefinition = (symbolA: FishSymbol, symbolB: FishSymbol): boolean => {
//   return symbolA.name === symbolB.name &&
//     symbolA.kind === symbolB.kind &&
//     symbolA.uri === symbolB.uri &&
//     doesSymbolContainScope(symbolA, symbolB);
// };
//
// // === NODE EQUALITY ===
//
// // Check if symbol equals a syntax node (with optional strict mode)
// export const doesSymbolEqualNode = (symbol: FishSymbol, node: SyntaxNode, strict = false): boolean => {
...
// export const doesSymbolScopeContainNode = (symbol: FishSymbol, node: SyntaxNode): boolean => {
//   return symbol.scope.containsPosition(getRange(node).start);
// };
//
// // Check if symbol contains a syntax node (by range)
// export const doesSymbolContainNode = (symbol: FishSymbol, node: SyntaxNode): boolean => {
//   return rangeContainsSyntaxNode(symbol.range, node);
// };
//
// // Check if symbol contains a position
// export const doesSymbolContainPosition = (symbol: FishSymbol, position: Position): boolean => {
//   const { line, character } = position;
...
//
// // Types for class extension
// type SymbolConstructor = typeof FishSymbol;
// //
// // // Alternative: Generic approach for maximum type safety
// type ExtendableSymbolClass<T extends FishSymbol = FishSymbol> = new (...args: any[]) => T;
// //
// // Extension methods for the FishSymbol class to maintain API compatibility
// // export const addEqualityAndContainmentMethods = <T extends FishSymbol>(
// //   FishSymbolClass: ExtendableSymbolClass<T>
// // ): ExtendableSymbolClass<T> => {
// //   // Equality methods
// //   FishSymbolClass.prototype.equals = function (other: FishSymbol): boolean {
// //     return areSymbolsEqual(this, other);
// //   };
// //
// //   FishSymbolClass.prototype.equalLocations = function (location: Location): boolean {
// //     return doesSymbolEqualLocation(this, location);
// //   };
// //
// //   FishSymbolClass.prototype.equalDefinition = function (other: FishSymbol): boolean {
// //     return areSymbolsSameDefinition(this, other);
// //   };
// //
// //   FishSymbolClass.prototype.equalsNode = function (node: SyntaxNode, strict = false): boolean {
// //     return doesSymbolEqualNode(this, node, strict);
// //   };
// //
// //   // Scope methods
// //   FishSymbolClass.prototype.containsScope = function (other: FishSymbol): boolean {
// //     return doesSymbolContainScope(this, other);
// //   };
// //
// //   FishSymbolClass.prototype.equalScopes = function (other: FishSymbol): boolean {
// //     return areSymbolScopesEqual(this, other);
// //   };
// //
// //   // Containment methods
// //   FishSymbolClass.prototype.scopeContainsNode = function (node: SyntaxNode): boolean {
// //     return doesSymbolScopeContainNode(this, node);
// //   };
// //
// //   FishSymbolClass.prototype.containsNode = function (node: SyntaxNode): boolean {
// //     return doesSymbolContainNode(this, node);
// //   };
// //
// //   FishSymbolClass.prototype.containsPosition = function (position: Position): boolean {
// //     return doesSymbolContainPosition(this, position);
// //   };
// //
// //   return FishSymbolClass;
// // };
//
// // Simpler alternative if you prefer direct typing
// export const addEqualityAndContainmentMethods = <T extends FishSymbol>(
//   FishSymbolClass: any
// ): ExtendableSymbolClass<T> => {
//   // Equality methods
...
// Extension methods for the FishSymbol class to maintain API compatibility
// NOTE: If using Solution 2 (direct method replacement), use these import names:
/*
import {
  equalSymbols,
  symbolEqualsLocation,
  equalSymbolDefinitions,
  symbolEqualsNode,
  symbolContainsScope,
  equalSymbolScopes,
  symbolScopeContainsNode,
  symbolContainsNode,
  symbolContainsPosition
} from './equality-utils';
