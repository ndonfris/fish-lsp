...
import { CompletionExample, FishStaticResolvedCompletionItem, FishStaticCompletionItem, FishCompletionItem } from './completion-types';


const EscapedChars: FishStaticCompletionItem[] = [
  {
    label: "\\a",
...
].map(item => FishCompletionItem.toStatic(item as FishStaticCompletionItem))

const Pipes : FishStaticCompletionItem[] = [
  {
    label: "<",
...
const StatusNumbers: FishStaticCompletionItem[] = [
  {
    label: "0",
...
const StringRegex: FishStaticCompletionItem[] = [
  {
    label: "*",
    detail: '0 >= MATCHES',
...
const FormatStrings: FishStaticCompletionItem[] = [
  {
    label: "%d",
...
const Combiners: FishStaticCompletionItem[] = [
  {
    label: "and",
...
].map(item => FishCompletionItem.toStaticResolved(item as FishStaticResolvedCompletionItem))


const Statements: FishStaticCompletionItem[] = [
  {
    label: "if",
