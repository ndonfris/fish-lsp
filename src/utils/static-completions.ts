...
import { CompletionExample, FishStaticResolvedCompletionItem, FishStaticCompletionItem } from './completion-types';
...
].map((item) => new FishStaticCompletionItem(item.label, item.detail, item.documentation))
...
].map((item) => new FishStaticResolvedCompletionItem(item.label, item.detail, item.documentation)) 
