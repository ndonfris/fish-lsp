...
//  • https://github.com/typescript-language-server/typescript-language-server/blob/114d4309cb1450585f991604118d3eff3690237c/src/configuration-manager.ts#L111
// 
// needs to be a protocal.d.ts file
// commandline --is-valid 'current typing'
//
// __fish_default_command_not_found_handler fish-error-file.fish
//  --> __fish_default_command_not_found
//    __fish_default_command_not_found_handler fish-error-file.fish
// 
...
declare namespace fish.server.protocol {
    ...
    interface FishClosingTagRequest extends FileLocationRequest {
        readonly command: CommandTypes.FishClosingTag;
        readonly arguments: FishClosingTagRequestArgs;
    }
    interface FishClosingTagRequestArgs extends FileLocationRequestArgs {
    }
    interface FishClosingTagResponse extends Response {
...
import {CompilerOptionsValue, FileExtensionInfo, HighlightSpanKind, MapLike, OutliningSpanKind, PluginImport, ProjectReference, ScriptElementKind, TextInsertion, TodoComment, TodoCommentDescriptor, TypeAcquisition} from 'typescript/lib/protocol';
import protocol = fish.server.protocol;
export = protocol;
