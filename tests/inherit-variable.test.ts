...
describe('--inherit-variable', () => {
  ...
  describe('autoloaded vs non-autoloaded duplicate inherit-variable definitions', () => {
    describe('with a mismatched functions/*.fish duplicate', () => {
      const workspace = TestWorkspace.create().addFiles(
        ...
        {
          relativePath: 'functions/B_duplicate.fish',
          content: [
            'function B --inherit-variable VAR',
            '    echo $VAR',
            'end',
      ...
      it('should ignore the duplicate when resolving inherited variables', () => {
        const docA = workspace.getDocument('functions/A.fish')!;
        const docB = workspace.getDocument('functions/B.fish')!;
    ...
    describe('with a conf.d duplicate', () => {
      const workspace = TestWorkspace.create().addFiles(
        ...
        {
          relativePath: 'conf.d/B_duplicate.fish',
          content: [
            'function B --inherit-variable VAR',
            '    echo $VAR',
            'end',
